...
def simulate_mean_vectors_one_target(
    ...
    return sum_cov / n_sub, sum_cor / n_sub
...
def main():
    ...
    ap.add_argument("--x_dist", choices=["normal", "uniform"], default="normal",
    ...
    for i in range(n_chunks):
        ...
        if args.use_one_target:
            mean_cov, mean_cor = simulate_mean_vectors_one_target(
                eig=eig1,
                x_aug=x_aug,
            ...
            mean_cov, mean_cor = simulate_mean_vectors_two_targets(
                eig1=eig1,
                eig2=eig2,
                x_aug=x_aug,
                n_time=int(args.n_time),
